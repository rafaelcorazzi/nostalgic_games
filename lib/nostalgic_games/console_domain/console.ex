defmodule NostalgicGames.Console do
  ...
  defp generate_uuid(%Ecto.Changeset{valid?: true, changes: %{console_plataform_code: console_plataform_code}} = changeset) do
    put_change(changeset, :console_id, UUID.uuid5("6ba7b811-9dad-11d1-80b4-00c04fd430c8", console_plataform_code))
  end
